...
<div class="row my-5  py-5" style="font-family: 'Noto Sans JP', sans-serif; color: #666666; background-color: #fff;">
    ...
    <div class="col mt-5">
      <img src="/img/diet_icon_2.png" class="rounded mx-auto d-block" style="width: 200px;">
    </div>

    <div class="col-sm-12 text-center mt-5 mb-4" style="color: #666;">
      <h1 class="font-weight-bold" style="font-family: 'Kosugi', sans-serif; line-height: 1.5; font-size: 20pt;">ダイエット・減量 <br>食事プログラム</h1>
    </div>
    <div class="col-sm-12 text-center mb-4" style="color: #666;">
      <p style="font-family: 'Kosugi', sans-serif;">体重・身長・運動強度からそれぞれに合ったスケジュールを作成します。</p>
    </div>

    <div class="col">
      <a class="btn btn-lg btn-outline-pink float-center my-1 mx-5 d-block mx-auto" href="#body_index_form" style="width: 250px;">始める</a>
    </div>
...
<div class="row my-3 px-3" style="font-family: 'Noto Sans JP', sans-serif; color: #666666; background-color: #fff; font-size: 10.5pt;">
